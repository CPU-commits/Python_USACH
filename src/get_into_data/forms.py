...
def __print_instructions():
    ...
    b_point = '\n B) El punto A está dado de esta forma ya que, es la manera más eficiente de gráficar y sacar estadisticas a parametros, que a primera vista, son subjetivos'
    c_point = '\n C) Considere el "0" como menos satisfecho, o la respuesta más negativa. Por el contrario, al "10", como la respuesta más positiva'
    print('\n Instrucciones: \n')
    print('1. En el menú de encuestas, seleccionar la opción "1) Crear encuestas"')
    print(f'2. Las encuestas tienen ciertas consideraciones: \n{a_point}{b_point}{c_point}')
    print('Tome en cuenta las consideraciones antes dadas para así mejorar sus métricas')
    print('3. Cree formularios completos con preguntas acorde a lo anteriormente dicho')
    print('4. Introdusca las respuestas de estudiantes (A través de Excel)')
    print('5. El archivo Excel debe llevar como nombre "forms.xlsx"')
    print('6. Para leer las respuestas, las hojas deben llevar el "id" del formulario como nombre. Consulte el "id" del formulario en la opción "4)"')
    print('7. Los datos requeridos son (columnas): \n A) Grupo (id)\n B) Estudiante (id)\n C) Pregunta (Posición)\n D) Respuesta (Escala 0 - 10) -> Enteros')
    print('Se empezará a leer desde la primera fila, por tanto, obvie escribir el nombre de las columnas')
    print('8. Guardar el archivo dentro de la carpeta "input" para su lectura, y posterior escritura. Si esta no está generada, puede crearla manualmente dentro de "src". (Cualquier error, será notificado para su corrección)\n')
